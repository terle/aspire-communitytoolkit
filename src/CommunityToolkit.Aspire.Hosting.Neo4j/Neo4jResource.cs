...
/// </summary>
public class Neo4jResource : ContainerResource, IResourceWithConnectionString
{
    ...
    public Neo4jResource(string name, ParameterResource? username, ParameterResource password) : base(name)
    {
